# Acoustics Classification Intermediate Skill

## Overview
This skill enables classification in the domain of acoustics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to acoustics. This includes tasks such as:
- measure quantities
- measure quantities
- predict behavior
...
1. The user explicitly requests classification in the context of acoustics
