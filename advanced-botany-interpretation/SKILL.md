# Advanced Botany Interpretation Skill

## Overview
This skill enables interpretation in the domain of botany (biology). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to botany. This includes tasks such as:
- measure expression
- classify organisms
- model populations

The skill leverages sequencing platforms and follows best practices established in the biology community.

## Trigger Conditions
This skill should be activated when:
1. The user explicitly requests interpretation in the context of botany
2. The task requires advanced-level understanding of biology principles
3. The output needs to be phylogenetic trees
4. The work involves botany methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of botany principles and methods
...
- **Tool Proficiency**: Effective use of bioinformatics pipelines
...
2. **Methodology**: Follow established botany protocols and best practices
...
- Adjacent botany skills for comprehensive analysis
...
7. Stay current with botany literature and methods

## Version Information
- Complexity Level: advanced
- Domain: biology
- Subdiscipline: botany
