# Advanced Big Data Verification Skill

## Overview
This skill enables verification in the domain of big-data (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to big-data. This includes tasks such as:
- build models
- extract features
- test hypotheses
...
1. The user explicitly requests verification in the context of big-data
...
4. The work involves big-data methodologies or techniques
...
2. **Methodology**: Follow established big-data protocols and best practices
...
7. Stay current with big-data literature and methods
