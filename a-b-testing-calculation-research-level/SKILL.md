# A B Testing Calculation Research Level Skill

## Overview
This skill enables calculation in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to a-b-testing. This includes tasks such as:
- visualize data
- visualize data
- test hypotheses
...
1. The user explicitly requests calculation in the context of a-b-testing
