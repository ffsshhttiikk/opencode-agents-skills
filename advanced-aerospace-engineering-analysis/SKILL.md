# Advanced Aerospace Engineering Analysis Skill

## Overview
This skill enables analysis in the domain of aerospace-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to aerospace-engineering. This includes tasks such as:
...
1. The user explicitly requests analysis in the context of aerospace-engineering
