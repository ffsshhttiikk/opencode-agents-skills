# Advanced Analytical Chemistry Estimation Skill

## Overview
This skill enables estimation in the domain of analytical-chemistry (chemistry). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to analytical-chemistry. This includes tasks such as:
- analyze spectra
- optimize yields
- predict reactions

The skill leverages spectroscopy and follows best practices established in the chemistry community.

## Trigger Conditions
This skill should be activated when:
1. The user explicitly requests estimation in the context of analytical-chemistry
2. The task requires fundamental-level understanding of chemistry principles
3. The output needs to be reaction mechanisms
...
- **Tool Proficiency**: Effective use of spectroscopy
