# Advanced Anomaly Detection Derivation Skill

## Overview
This skill enables derivation in the domain of anomaly-detection (data-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to anomaly-detection. This includes tasks such as:
- visualize data
- analyze datasets
- build models
...
1. The user explicitly requests derivation in the context of anomaly-detection
