# Advanced Cartography Analysis Skill

## Overview
This skill enables analysis in the domain of cartography (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to cartography. This includes tasks such as:
- model processes
- interpret data
- analyze samples
...
1. The user explicitly requests analysis in the context of cartography
