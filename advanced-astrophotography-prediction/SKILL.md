# Advanced Astrophotography Prediction Skill

## Overview
This skill enables prediction in the domain of astrophotography (astronomy). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to astrophotography. This includes tasks such as:
- model phenomena
- calculate orbits
- model phenomena
...
1. The user explicitly requests prediction in the context of astrophotography
