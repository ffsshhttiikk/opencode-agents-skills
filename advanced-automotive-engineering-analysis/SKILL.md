# Advanced Automotive Engineering Analysis Skill

## Overview
This skill enables analysis in the domain of automotive-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to automotive-engineering. This includes tasks such as:
- validate designs
- validate designs
- analyze structures
...
1. The user explicitly requests analysis in the context of automotive-engineering
