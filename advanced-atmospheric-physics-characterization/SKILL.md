# Advanced Atmospheric Physics Characterization Skill

## Overview
This skill enables characterization in the domain of atmospheric-physics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to atmospheric-physics. This includes tasks such as:
- predict behavior
- model systems
- analyze motion
...
1. The user explicitly requests characterization in the context of atmospheric-physics
