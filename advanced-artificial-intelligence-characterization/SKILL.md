# Advanced Artificial Intelligence Characterization Skill

## Overview
This skill enables characterization in the domain of artificial-intelligence (computer-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to artificial-intelligence. This includes tasks such as:
- train models
- train models
- design systems
...
1. The user explicitly requests characterization in the context of artificial-intelligence
