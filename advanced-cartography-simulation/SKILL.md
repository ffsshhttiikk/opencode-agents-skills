# Advanced Cartography Simulation Skill

## Overview
This skill enables simulation in the domain of cartography (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to cartography. This includes tasks such as:
- interpret data
- analyze samples
- interpret data
...
1. The user explicitly requests simulation in the context of cartography
