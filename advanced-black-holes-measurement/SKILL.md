# Advanced Black Holes Measurement Skill

## Overview
This skill enables measurement in the domain of black-holes (astronomy). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to black-holes. This includes tasks such as:
- measure distances
- analyze spectra
- calculate orbits
...
1. The user explicitly requests measurement in the context of black-holes
