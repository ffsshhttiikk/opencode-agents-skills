# Advanced Causal Inference Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of causal-inference (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to causal-inference. This includes tasks such as:
- predict outcomes
- build models
- analyze datasets
...
1. The user explicitly requests troubleshooting in the context of causal-inference
