# Advanced Cell Biology Optimization Skill

## Overview
This skill enables optimization in the domain of cell-biology (biology). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to cell-biology. This includes tasks such as:
- analyze proteins
- measure expression
- analyze proteins
...
1. The user explicitly requests optimization in the context of cell-biology
