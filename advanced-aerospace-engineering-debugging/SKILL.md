# Advanced Aerospace Engineering Debugging Skill

## Overview
This skill enables debugging in the domain of aerospace-engineering (engineering). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to aerospace-engineering. This includes tasks such as:
- analyze structures
...
1. The user explicitly requests debugging in the context of aerospace-engineering
