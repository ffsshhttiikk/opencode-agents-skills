# Advanced Bioinformatics Analysis Skill

## Overview
This skill enables analysis in the domain of bioinformatics (biology). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to bioinformatics. This includes tasks such as:
- study interactions
- classify organisms
- study interactions
...
1. The user explicitly requests analysis in the context of bioinformatics
