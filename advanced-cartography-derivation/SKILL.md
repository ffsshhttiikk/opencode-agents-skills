# Advanced Cartography Derivation Skill

## Overview
This skill enables derivation in the domain of cartography (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to cartography. This includes tasks such as:
- analyze samples
- interpret data
- measure properties
...
1. The user explicitly requests derivation in the context of cartography
