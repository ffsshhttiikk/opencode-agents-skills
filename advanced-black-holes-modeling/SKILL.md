# Advanced Black Holes Modeling Skill

## Overview
This skill enables modeling in the domain of black-holes (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to black-holes. This includes tasks such as:
- calculate orbits
- observe objects
- model phenomena
...
1. The user explicitly requests modeling in the context of black-holes
