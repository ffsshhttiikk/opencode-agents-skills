# Advanced Astrophotography Synthesis Skill

## Overview
This skill enables synthesis in the domain of astrophotography (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to astrophotography. This includes tasks such as:
- analyze spectra
- model phenomena
- analyze spectra
...
1. The user explicitly requests synthesis in the context of astrophotography
