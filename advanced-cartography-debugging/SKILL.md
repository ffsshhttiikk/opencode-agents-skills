# Advanced Cartography Debugging Skill

## Overview
This skill enables debugging in the domain of cartography (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to cartography. This includes tasks such as:
- analyze samples
- analyze samples
- analyze samples
...
1. The user explicitly requests debugging in the context of cartography
