# Advanced Anomaly Detection Prediction Skill

## Overview
This skill enables prediction in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to anomaly-detection. This includes tasks such as:
- analyze datasets
- build models
- build models
...
1. The user explicitly requests prediction in the context of anomaly-detection
