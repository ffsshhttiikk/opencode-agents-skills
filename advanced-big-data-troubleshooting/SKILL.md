# Advanced Big Data Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of big-data (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to big-data. This includes tasks such as:
- analyze datasets
- visualize data
- extract features
...
1. The user explicitly requests troubleshooting in the context of big-data
