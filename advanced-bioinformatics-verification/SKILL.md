# Advanced Bioinformatics Verification Skill

## Overview
This skill enables verification in the domain of bioinformatics (biology). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to bioinformatics. This includes tasks such as:
- measure expression
- study interactions
- study interactions
...
1. The user explicitly requests verification in the context of bioinformatics
