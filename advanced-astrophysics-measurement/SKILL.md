# Advanced Astrophysics Measurement Skill

## Overview
This skill enables measurement in the domain of astrophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to astrophysics. This includes tasks such as:
...
1. The user explicitly requests measurement in the context of astrophysics
