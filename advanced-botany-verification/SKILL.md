# Advanced Botany Verification Skill

## Overview
This skill enables verification in the domain of botany (biology). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to botany. This includes tasks such as:
- study interactions
- analyze proteins
- model populations
...
1. The user explicitly requests verification in the context of botany
2. The task requires expert-level understanding of biology principles
