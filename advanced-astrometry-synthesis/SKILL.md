# Advanced Astrometry Synthesis Skill

## Overview
This skill enables synthesis in the domain of astrometry (astronomy). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to astrometry. This includes tasks such as:
- observe objects
- measure distances
- detect signals
...
1. The user explicitly requests synthesis in the context of astrometry
