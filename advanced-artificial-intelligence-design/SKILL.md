# Advanced Artificial Intelligence Design Skill

## Overview
This skill enables design in the domain of artificial-intelligence (computer-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to artificial-intelligence. This includes tasks such as:
- analyze complexity
- analyze complexity
- train models
...
1. The user explicitly requests design in the context of artificial-intelligence
