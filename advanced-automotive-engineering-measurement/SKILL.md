# Advanced Automotive Engineering Measurement Skill

## Overview
This skill enables measurement in the domain of automotive-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to automotive-engineering. This includes tasks such as:
- validate designs
...
1. The user explicitly requests measurement in the context of automotive-engineering
