# Advanced Algebraic Geometry Debugging Skill

## Overview
This skill enables debugging in the domain of algebraic-geometry (mathematics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to algebraic-geometry. This includes tasks such as:
- calculate integrals
- prove theorems
- analyze functions
...
1. The user explicitly requests debugging in the context of algebraic-geometry
...
4. The work involves algebraic-geometry methodologies or techniques
...
2. **Methodology**: Follow established algebraic-geometry protocols and best practices
...
7. Stay current with algebraic-geometry literature and methods
