# Advanced Anomaly Detection Debugging Skill

## Overview
This skill enables debugging in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to anomaly-detection. This includes tasks such as:
- predict outcomes
- test hypotheses
- test hypotheses
...
1. The user explicitly requests debugging in the context of anomaly-detection
