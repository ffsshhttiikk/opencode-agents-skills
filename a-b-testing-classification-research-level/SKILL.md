# A B Testing Classification Research Level Skill

## Overview
This skill enables classification in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to a-b-testing. This includes tasks such as:
- test hypotheses
- visualize data
- predict outcomes
...
1. The user explicitly requests classification in the context of a-b-testing
