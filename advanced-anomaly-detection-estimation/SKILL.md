# Advanced Anomaly Detection Estimation Skill

## Overview
This skill enables estimation in the domain of anomaly-detection (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to anomaly-detection. This includes tasks such as:
- extract features
- build models
- visualize data
...
1. The user explicitly requests estimation in the context of anomaly-detection
