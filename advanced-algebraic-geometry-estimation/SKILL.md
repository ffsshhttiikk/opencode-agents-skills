# Advanced Algebraic Geometry Estimation Skill

## Overview
This skill enables estimation in the domain of algebraic-geometry (mathematics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to algebraic-geometry. This includes tasks such as:
- prove theorems
- compute derivatives
- find eigenvalues
...
1. The user explicitly requests estimation in the context of algebraic-geometry
