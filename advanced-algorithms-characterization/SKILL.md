# Advanced Algorithms Characterization Skill

## Overview
This skill enables characterization in the domain of algorithms (computer-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to algorithms. This includes tasks such as:
...
1. The user explicitly requests characterization in the context of algorithms
