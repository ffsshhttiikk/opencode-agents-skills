# Advanced Astrochemistry Characterization Skill

## Overview
This skill enables characterization in the domain of astrochemistry (chemistry). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to astrochemistry. This includes tasks such as:
- analyze spectra
- analyze spectra
- analyze spectra
...
1. The user explicitly requests characterization in the context of astrochemistry
