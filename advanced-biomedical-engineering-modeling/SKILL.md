# Advanced Biomedical Engineering Modeling Skill

## Overview
This skill enables modeling in the domain of biomedical-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to biomedical-engineering. This includes tasks such as:
- analyze structures
- test prototypes
- validate designs
...
1. The user explicitly requests modeling in the context of biomedical-engineering
