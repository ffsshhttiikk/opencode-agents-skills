# Advanced Automotive Engineering Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of automotive-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to automotive-engineering. This includes tasks such as:
...
1. The user explicitly requests troubleshooting in the context of automotive-engineering
