# Advanced Calculus Simulation Skill

## Overview
This skill enables simulation in the domain of calculus (mathematics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to calculus. This includes tasks such as:
- compute derivatives
- solve equations
- solve equations
...
1. The user explicitly requests simulation in the context of calculus
