# Advanced Bayesian Statistics Derivation Skill

## Overview
This skill enables derivation in the domain of bayesian-statistics (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to bayesian-statistics. This includes tasks such as:
- analyze datasets
- test hypotheses
- analyze datasets
...
1. The user explicitly requests derivation in the context of bayesian-statistics
