# Acoustics Verification Advanced Skill

## Overview
This skill enables verification in the domain of acoustics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to acoustics. This includes tasks such as:
- calculate forces
- model systems
...
1. The user explicitly requests verification in the context of acoustics
2. The task requires advanced-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves acoustics methodologies or techniques
...
2. **Methodology**: Follow established acoustics protocols and best practices
...
7. Stay current with acoustics literature and methods
