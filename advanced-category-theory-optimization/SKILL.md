# Advanced Category Theory Optimization Skill

## Overview
This skill enables optimization in the domain of category-theory (mathematics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to category-theory. This includes tasks such as:
- analyze functions
- solve equations
- compute derivatives
...
1. The user explicitly requests optimization in the context of category-theory
2. The task requires expert-level understanding of mathematics principles
3. The output needs to be mathematical proofs
4. The work involves category-theory methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of category-theory principles and methods
...
2. **Methodology**: Follow established category-theory protocols and best practices
...
- Adjacent category-theory skills for comprehensive analysis
...
7. Stay current with category-theory literature and methods
