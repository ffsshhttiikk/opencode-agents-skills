# Advanced Bayesian Statistics Classification Skill

## Overview
This skill enables classification in the domain of bayesian-statistics (data-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to bayesian-statistics. This includes tasks such as:
- extract features
- extract features
- visualize data
...
1. The user explicitly requests classification in the context of bayesian-statistics
