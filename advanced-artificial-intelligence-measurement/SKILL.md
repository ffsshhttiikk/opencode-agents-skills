# Advanced Artificial Intelligence Measurement Skill

## Overview
This skill enables measurement in the domain of artificial-intelligence (computer-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to artificial-intelligence. This includes tasks such as:
...
1. The user explicitly requests measurement in the context of artificial-intelligence
