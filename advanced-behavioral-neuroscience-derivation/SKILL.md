# Advanced Behavioral Neuroscience Derivation Skill

## Overview
This skill enables derivation in the domain of behavioral-neuroscience (neuroscience). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to behavioral-neuroscience. This includes tasks such as:
- study behavior
- map connections
- model circuits
...
1. The user explicitly requests derivation in the context of behavioral-neuroscience
