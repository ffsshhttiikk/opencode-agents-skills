# Advanced Chemical Engineering Testing Skill

## Overview
This skill enables testing in the domain of chemical-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to chemical-engineering. This includes tasks such as:
- analyze structures
- optimize processes
- analyze structures
...
1. The user explicitly requests testing in the context of chemical-engineering
...
4. The work involves chemical-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of chemical-engineering principles and methods
...
2. **Methodology**: Follow established chemical-engineering protocols and best practices
...
- Adjacent chemical-engineering skills for comprehensive analysis
...
7. Stay current with chemical-engineering literature and methods
