# Advanced Calculus Prediction Skill

## Overview
This skill enables prediction in the domain of calculus (mathematics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to calculus. This includes tasks such as:
- calculate integrals
- prove theorems
- find eigenvalues
...
1. The user explicitly requests prediction in the context of calculus
