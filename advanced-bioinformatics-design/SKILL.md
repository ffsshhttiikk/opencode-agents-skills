# Advanced Bioinformatics Design Skill

## Overview
This skill enables design in the domain of bioinformatics (biology). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to bioinformatics. This includes tasks such as:
- model populations
- model populations
- model populations
...
1. The user explicitly requests design in the context of bioinformatics
