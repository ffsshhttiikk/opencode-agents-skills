# Advanced Astrobiology Simulation Skill

## Overview
This skill enables simulation in the domain of astrobiology (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to astrobiology. This includes tasks such as:
- calculate orbits
- model phenomena
- observe objects
...
1. The user explicitly requests simulation in the context of astrobiology
