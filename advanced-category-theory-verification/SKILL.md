# Advanced Category Theory Verification Skill

## Overview
This skill enables verification in the domain of category-theory (mathematics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to category-theory. This includes tasks such as:
- find eigenvalues
- compute derivatives
- calculate integrals
...
1. The user explicitly requests verification in the context of category-theory
