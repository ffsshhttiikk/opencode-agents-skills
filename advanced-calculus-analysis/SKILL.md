# Advanced Calculus Analysis Skill

## Overview
This skill enables analysis in the domain of calculus (mathematics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to calculus. This includes tasks such as:
- prove theorems
- solve equations
- compute derivatives
...
1. The user explicitly requests analysis in the context of calculus
