# Advanced Bayesian Statistics Optimization Skill

## Overview
This skill enables optimization in the domain of bayesian-statistics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to bayesian-statistics. This includes tasks such as:
- build models
- visualize data
- build models
...
1. The user explicitly requests optimization in the context of bayesian-statistics
