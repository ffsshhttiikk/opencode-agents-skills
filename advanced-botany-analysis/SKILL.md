...
## Overview
This skill enables analysis in the domain of botany (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to botany. This includes tasks such as:
- measure expression
- sequence DNA
- classify organisms
...
1. The user explicitly requests analysis in the context of botany
...
## Output Format
The skill produces phylogenetic trees in standardized formats appropriate for biology applications. Outputs include:
