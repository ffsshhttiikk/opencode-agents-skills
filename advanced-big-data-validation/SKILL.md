# Advanced Big Data Validation Skill

## Overview
This skill enables validation in the domain of big-data (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to big-data. This includes tasks such as:
- build models
- test hypotheses
- analyze datasets
...
1. The user explicitly requests validation in the context of big-data
