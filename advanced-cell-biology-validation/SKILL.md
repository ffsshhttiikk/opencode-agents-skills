# Advanced Cell Biology Validation Skill

## Overview
This skill enables validation in the domain of cell-biology (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to cell-biology. This includes tasks such as:
- study interactions
- model populations
- measure expression
...
1. The user explicitly requests validation in the context of cell-biology
