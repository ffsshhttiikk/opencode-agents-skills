# Advanced Bioinformatics Characterization Skill

## Overview
This skill enables characterization in the domain of bioinformatics (biology). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to bioinformatics. This includes tasks such as:
- model populations
- measure expression
- classify organisms
...
1. The user explicitly requests characterization in the context of bioinformatics
