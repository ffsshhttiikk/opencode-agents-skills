# Advanced Atmospheric Physics Modeling Skill

## Overview
This skill enables modeling in the domain of atmospheric-physics (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to atmospheric-physics. This includes tasks such as:
- measure quantities
- calculate forces
- model systems
...
1. The user explicitly requests modeling in the context of atmospheric-physics
