# Advanced Bayesian Statistics Measurement Skill

## Overview
This skill enables measurement in the domain of bayesian-statistics (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to bayesian-statistics. This includes tasks such as:
- analyze datasets
- test hypotheses
- predict outcomes
...
1. The user explicitly requests measurement in the context of bayesian-statistics
