# Advanced Big Data Design Skill

## Overview
This skill enables design in the domain of big-data (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.
...
1. The user explicitly requests design in the context of big-data
