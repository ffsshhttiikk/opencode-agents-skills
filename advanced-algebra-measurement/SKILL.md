# Advanced Algebra Measurement Skill

## Overview
This skill enables measurement in the domain of algebra (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to algebra. This includes tasks such as:
- analyze functions
- find eigenvalues
- prove theorems
...
1. The user explicitly requests measurement in the context of algebra
