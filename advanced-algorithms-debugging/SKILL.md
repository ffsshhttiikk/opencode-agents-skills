# Advanced Algorithms Debugging Skill

## Overview
This skill enables debugging in the domain of algorithms (computer-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to algorithms. This includes tasks such as:
- train models
- train models
- optimize code
...
1. The user explicitly requests debugging in the context of algorithms
