# Advanced Biomedical Engineering Calculation Skill

## Overview
This skill enables calculation in the domain of biomedical-engineering (engineering). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to biomedical-engineering. This includes tasks such as:
- test prototypes
- design components
- design components
...
1. The user explicitly requests calculation in the context of biomedical-engineering
2. The task requires advanced-level understanding of engineering principles
3. The output needs to be engineering designs
4. The work involves biomedical-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of biomedical-engineering principles and methods
...
- **Tool Proficiency**: Effective use of CAD software
...
2. **Methodology**: Follow established biomedical-engineering protocols and best practices
...
- Adjacent biomedical-engineering skills for comprehensive analysis
...
7. Stay current with biomedical-engineering literature and methods
