# A B Testing Validation Research Level Skill

## Overview
This skill enables validation in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to a-b-testing. This includes tasks such as:
- build models
- predict outcomes
- extract features
...
1. The user explicitly requests validation in the context of a-b-testing
