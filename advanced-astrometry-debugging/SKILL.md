# Advanced Astrometry Debugging Skill

## Overview
This skill enables debugging in the domain of astrometry (astronomy). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to astrometry. This includes tasks such as:
- model phenomena
- model phenomena
- model phenomena
...
1. The user explicitly requests debugging in the context of astrometry
