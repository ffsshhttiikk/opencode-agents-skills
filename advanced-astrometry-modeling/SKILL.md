# Advanced Astrometry Modeling Skill

## Overview
This skill enables modeling in the domain of astrometry (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to astrometry. This includes tasks such as:
- analyze spectra
- analyze spectra
- observe objects
...
1. The user explicitly requests modeling in the context of astrometry
