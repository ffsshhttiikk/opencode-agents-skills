# Advanced Algebraic Geometry Optimization Skill

## Overview
This skill enables optimization in the domain of algebraic-geometry (mathematics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to algebraic-geometry. This includes tasks such as:
- prove theorems
- analyze functions
- compute derivatives
...
1. The user explicitly requests optimization in the context of algebraic-geometry
