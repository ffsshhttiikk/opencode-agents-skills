# A B Testing Derivation Research Level Skill

## Overview
This skill enables derivation in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to a-b-testing. This includes tasks such as:
- extract features
- build models
- visualize data
...
1. The user explicitly requests derivation in the context of a-b-testing
