# Advanced Causal Inference Characterization Skill

## Overview
This skill enables characterization in the domain of causal-inference (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to causal-inference. This includes tasks such as:
- test hypotheses
- analyze datasets
- extract features
...
1. The user explicitly requests characterization in the context of causal-inference
