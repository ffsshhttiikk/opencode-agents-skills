# Acoustics Design Fundamental Skill

## Overview
This skill enables design in the domain of acoustics (physics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to acoustics. This includes tasks such as:
- measure quantities
...
1. The user explicitly requests design in the context of acoustics
