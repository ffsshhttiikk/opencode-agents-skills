# Advanced Algebraic Geometry Synthesis Skill

## Overview
This skill enables synthesis in the domain of algebraic-geometry (mathematics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to algebraic-geometry. This includes tasks such as:
- compute derivatives
- prove theorems
- find eigenvalues
...
1. The user explicitly requests synthesis in the context of algebraic-geometry
