# A B Testing Design Fundamental Skill

## Overview
This skill enables design in the domain of a-b-testing (data-science). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.
