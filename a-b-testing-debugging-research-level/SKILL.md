# A B Testing Debugging Research Level Skill

## Overview
This skill enables debugging in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to a-b-testing. This includes tasks such as:
- extract features
- build models
- visualize data
...
1. The user explicitly requests debugging in the context of a-b-testing
