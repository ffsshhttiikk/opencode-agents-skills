# Advanced Anomaly Detection Measurement Skill

## Overview
This skill enables measurement in the domain of anomaly-detection (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to anomaly-detection. This includes tasks such as:
- visualize data
- analyze datasets
- extract features
...
1. The user explicitly requests measurement in the context of anomaly-detection
