# Advanced Chemical Engineering Measurement Skill

## Overview
This skill enables measurement in the domain of chemical-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to chemical-engineering. This includes tasks such as:
- design components
- optimize processes
- analyze structures
...
1. The user explicitly requests measurement in the context of chemical-engineering
