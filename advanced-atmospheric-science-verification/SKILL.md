# Advanced Atmospheric Science Verification Skill

## Overview
This skill enables verification in the domain of atmospheric-science (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to atmospheric-science. This includes tasks such as:
- analyze samples
- predict events
- model processes
...
1. The user explicitly requests verification in the context of atmospheric-science
2. The task requires expert-level understanding of earth-sciences principles
