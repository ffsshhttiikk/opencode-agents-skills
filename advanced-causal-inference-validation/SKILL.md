# Advanced Causal Inference Validation Skill

## Overview
This skill enables validation in the domain of causal-inference (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to causal-inference. This includes tasks such as:
- extract features
- build models
- extract features
...
1. The user explicitly requests validation in the context of causal-inference
