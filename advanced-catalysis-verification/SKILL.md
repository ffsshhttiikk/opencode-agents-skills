# Advanced Catalysis Verification Skill

## Overview
This skill enables verification in the domain of catalysis (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to catalysis. This includes tasks such as:
...
1. The user explicitly requests verification in the context of catalysis
...
4. The work involves catalysis methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of catalysis principles and methods
- **Practical Application**: Ability to apply verification techniques to real-world problems
...
2. **Methodology**: Follow established catalysis protocols and best practices
...
- Adjacent catalysis skills for comprehensive analysis
...
7. Stay current with catalysis literature and methods

## Version Information
- Complexity Level: research-level
- Domain: chemistry
- Subdiscipline: catalysis
