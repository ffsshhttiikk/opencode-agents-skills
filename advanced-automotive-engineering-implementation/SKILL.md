# Advanced Automotive Engineering Implementation Skill

## Overview
This skill enables implementation in the domain of automotive-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to automotive-engineering. This includes tasks such as:
- design components
- optimize processes
- design components
...
1. The user explicitly requests implementation in the context of automotive-engineering
