# Advanced Astrobiology Prediction Skill

## Overview
This skill enables prediction in the domain of astrobiology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to astrobiology. This includes tasks such as:
- calculate orbits
- detect signals
- model phenomena
...
1. The user explicitly requests prediction in the context of astrobiology
2. The task requires research-level-level understanding of astronomy principles
