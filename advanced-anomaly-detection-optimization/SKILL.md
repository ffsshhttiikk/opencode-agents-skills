# Advanced Anomaly Detection Optimization Skill

## Overview
This skill enables optimization in the domain of anomaly-detection (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to anomaly-detection. This includes tasks such as:
- analyze datasets
- test hypotheses
- analyze datasets
...
1. The user explicitly requests optimization in the context of anomaly-detection
