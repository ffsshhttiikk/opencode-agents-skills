# Advanced Atmospheric Physics Simulation Skill

## Overview
This skill enables simulation in the domain of atmospheric-physics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to atmospheric-physics. This includes tasks such as:
- model systems
- predict behavior
- predict behavior
...
1. The user explicitly requests simulation in the context of atmospheric-physics
