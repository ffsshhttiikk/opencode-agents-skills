# Advanced Atmospheric Science Estimation Skill

## Overview
This skill enables estimation in the domain of atmospheric-science (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to atmospheric-science. This includes tasks such as:
- map features
- analyze samples
- predict events
...
1. The user explicitly requests estimation in the context of atmospheric-science
