# Advanced Cartography Calculation Skill

## Overview
This skill enables calculation in the domain of cartography (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to cartography. This includes tasks such as:
- analyze samples
- predict events
- analyze samples
...
1. The user explicitly requests calculation in the context of cartography
