# Advanced Cell Biology Calculation Skill

## Overview
This skill enables calculation in the domain of cell-biology (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to cell-biology. This includes tasks such as:
- measure expression
- analyze proteins
- analyze proteins
...
1. The user explicitly requests calculation in the context of cell-biology
