# Advanced Astrometry Analysis Skill

## Overview
This skill enables analysis in the domain of astrometry (astronomy). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to astrometry. This includes tasks such as:
- model phenomena
- calculate orbits
- measure distances
...
1. The user explicitly requests analysis in the context of astrometry
