# Advanced Bayesian Statistics Debugging Skill

## Overview
This skill enables debugging in the domain of bayesian-statistics (data-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to bayesian-statistics. This includes tasks such as:
- analyze datasets
- analyze datasets
- extract features
...
1. The user explicitly requests debugging in the context of bayesian-statistics
