# Advanced Behavioral Neuroscience Prediction Skill

## Overview
This skill enables prediction in the domain of behavioral-neuroscience (neuroscience). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to behavioral-neuroscience. This includes tasks such as:
...
1. The user explicitly requests prediction in the context of behavioral-neuroscience
