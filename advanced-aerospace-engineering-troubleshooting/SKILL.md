# Advanced Aerospace Engineering Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of aerospace-engineering (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to aerospace-engineering. This includes tasks such as:
- analyze structures
- test prototypes
- validate designs
...
1. The user explicitly requests troubleshooting in the context of aerospace-engineering
