# Advanced Black Holes Testing Skill

## Overview
This skill enables testing in the domain of black-holes (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to black-holes. This includes tasks such as:
- measure distances
- analyze spectra
- detect signals
...
1. The user explicitly requests testing in the context of black-holes
