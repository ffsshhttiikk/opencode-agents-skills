# Advanced Civil Engineering Modeling Skill

## Overview
This skill enables modeling in the domain of civil-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to civil-engineering. This includes tasks such as:
- optimize processes
...
1. The user explicitly requests modeling in the context of civil-engineering
