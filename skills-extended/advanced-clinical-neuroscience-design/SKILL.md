# Advanced Clinical Neuroscience Design Skill

## Overview
This skill enables design in the domain of clinical-neuroscience (neuroscience). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to clinical-neuroscience. This includes tasks such as:
- map connections
...
1. The user explicitly requests design in the context of clinical-neuroscience
