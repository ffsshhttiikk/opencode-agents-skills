# Advanced Classical Mechanics Analysis Skill

## Overview
This skill enables analysis in the domain of classical-mechanics (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to classical-mechanics. This includes tasks such as:
- measure quantities
- model systems
- model systems

The skill leverages measurement devices and follows best practices established in the physics community.

## Trigger Conditions
This skill should be activated when:
1. The user explicitly requests analysis in the context of classical-mechanics
2. The task requires expert-level understanding of physics principles
3. The output needs to be experimental results
4. The work involves classical-mechanics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of classical-mechanics principles and methods
...
- **Tool Proficiency**: Effective use of measurement devices
...
2. **Methodology**: Follow established classical-mechanics protocols and best practices
...
## Output Format
The skill produces experimental results in standardized formats appropriate for physics applications. Outputs include:
...
- Adjacent classical-mechanics skills for comprehensive analysis
...
7. Stay current with classical-mechanics literature and methods

## Version Information
- Complexity Level: expert
- Domain: physics
- Subdiscipline: classical-mechanics
- Skill Type: analysis
- Last Updated: 2025
