# Advanced Classical Mechanics Calculation Skill

## Overview
This skill enables calculation in the domain of classical-mechanics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to classical-mechanics. This includes tasks such as:
- model systems
- predict behavior
- calculate forces
...
1. The user explicitly requests calculation in the context of classical-mechanics
