# Advanced Climate Science Simulation Skill

## Overview
This skill enables simulation in the domain of climate-science (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to climate-science. This includes tasks such as:
- interpret data
- map features
- predict events
...
1. The user explicitly requests simulation in the context of climate-science
