# Advanced Clinical Neuroscience Synthesis Skill

## Overview
This skill enables synthesis in the domain of clinical-neuroscience (neuroscience). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to clinical-neuroscience. This includes tasks such as:
...
1. The user explicitly requests synthesis in the context of clinical-neuroscience
