# Advanced Clinical Neuroscience Derivation Skill

## Overview
This skill enables derivation in the domain of clinical-neuroscience (neuroscience). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to clinical-neuroscience. This includes tasks such as:
...
1. The user explicitly requests derivation in the context of clinical-neuroscience
