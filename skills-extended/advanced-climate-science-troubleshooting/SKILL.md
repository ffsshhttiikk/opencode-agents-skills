# Advanced Climate Science Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of climate-science (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to climate-science. This includes tasks such as:
- model processes
- map features
- analyze samples
...
1. The user explicitly requests troubleshooting in the context of climate-science
