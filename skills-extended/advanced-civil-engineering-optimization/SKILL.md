# Advanced Civil Engineering Optimization Skill

## Overview
This skill enables optimization in the domain of civil-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to civil-engineering. This includes tasks such as:
- analyze structures
...
1. The user explicitly requests optimization in the context of civil-engineering
