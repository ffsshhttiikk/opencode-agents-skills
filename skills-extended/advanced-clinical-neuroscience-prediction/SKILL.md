# Advanced Clinical Neuroscience Prediction Skill

## Overview
This skill enables prediction in the domain of clinical-neuroscience (neuroscience). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to clinical-neuroscience. This includes tasks such as:
- measure responses
...
1. The user explicitly requests prediction in the context of clinical-neuroscience
