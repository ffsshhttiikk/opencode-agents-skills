# Advanced Cloud Computing Interpretation Skill

## Overview
This skill enables interpretation in the domain of cloud-computing (computer-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to cloud-computing. This includes tasks such as:
- design systems
- analyze complexity
- optimize code
...
1. The user explicitly requests interpretation in the context of cloud-computing
