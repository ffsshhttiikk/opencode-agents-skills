# Advanced Clinical Neuroscience Measurement Skill

## Overview
This skill enables measurement in the domain of clinical-neuroscience (neuroscience). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to clinical-neuroscience. This includes tasks such as:
- map connections
- model circuits
...
1. The user explicitly requests measurement in the context of clinical-neuroscience
