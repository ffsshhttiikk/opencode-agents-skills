# Advanced Climate Science Design Skill

## Overview
This skill enables design in the domain of climate-science (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to climate-science. This includes tasks such as:
- model processes
- model processes
- predict events
...
1. The user explicitly requests design in the context of climate-science
