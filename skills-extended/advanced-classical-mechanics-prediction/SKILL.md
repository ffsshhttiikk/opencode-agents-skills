# Advanced Classical Mechanics Prediction Skill

## Overview
This skill enables prediction in the domain of classical-mechanics (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to classical-mechanics. This includes tasks such as:
- analyze motion
- analyze motion
- measure quantities
...
1. The user explicitly requests prediction in the context of classical-mechanics
