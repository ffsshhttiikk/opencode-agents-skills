# Advanced Civil Engineering Simulation Skill

## Overview
This skill enables simulation in the domain of civil-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to civil-engineering. This includes tasks such as:
- analyze structures
- validate designs
- design components
...
1. The user explicitly requests simulation in the context of civil-engineering
