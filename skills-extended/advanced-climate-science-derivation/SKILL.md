# Advanced Climate Science Derivation Skill

## Overview
This skill enables derivation in the domain of climate-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to climate-science. This includes tasks such as:
- model processes
- model processes
- map features
...
1. The user explicitly requests derivation in the context of climate-science
