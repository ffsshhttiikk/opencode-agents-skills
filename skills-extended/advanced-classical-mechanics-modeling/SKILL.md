# Advanced Classical Mechanics Modeling Skill

## Overview
This skill enables modeling in the domain of classical-mechanics (physics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to classical-mechanics. This includes tasks such as:
- measure quantities
- predict behavior
...
1. The user explicitly requests modeling in the context of classical-mechanics
2. The task requires fundamental-level understanding of physics principles
