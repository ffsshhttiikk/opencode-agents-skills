# Advanced Climate Science Calculation Skill

## Overview
This skill enables calculation in the domain of climate-science (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to climate-science. This includes tasks such as:
- model processes
- predict events
- interpret data
...
1. The user explicitly requests calculation in the context of climate-science
