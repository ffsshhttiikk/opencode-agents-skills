# Advanced Classical Mechanics Estimation Skill

## Overview
This skill enables estimation in the domain of classical-mechanics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to classical-mechanics. This includes tasks such as:
- analyze motion
...
1. The user explicitly requests estimation in the context of classical-mechanics
