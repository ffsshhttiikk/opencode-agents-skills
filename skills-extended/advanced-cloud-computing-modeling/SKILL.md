# Advanced Cloud Computing Modeling Skill

## Overview
This skill enables modeling in the domain of cloud-computing (computer-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to cloud-computing. This includes tasks such as:
- design systems
...
1. The user explicitly requests modeling in the context of cloud-computing
