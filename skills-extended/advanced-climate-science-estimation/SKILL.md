# Advanced Climate Science Estimation Skill

## Overview
This skill enables estimation in the domain of climate-science (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to climate-science. This includes tasks such as:
- predict events
- model processes
- measure properties
...
1. The user explicitly requests estimation in the context of climate-science
