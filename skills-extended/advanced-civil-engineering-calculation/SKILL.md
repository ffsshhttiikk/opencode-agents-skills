# Advanced Civil Engineering Calculation Skill

## Overview
This skill enables calculation in the domain of civil-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to civil-engineering. This includes tasks such as:
- analyze structures
- design components
- test prototypes
...
1. The user explicitly requests calculation in the context of civil-engineering
