# Advanced Civil Engineering Synthesis Skill

## Overview
This skill enables synthesis in the domain of civil-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to civil-engineering. This includes tasks such as:
- validate designs
- design components
- test prototypes
...
1. The user explicitly requests synthesis in the context of civil-engineering
