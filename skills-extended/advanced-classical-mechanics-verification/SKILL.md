# Advanced Classical Mechanics Verification Skill

## Overview
This skill enables verification in the domain of classical-mechanics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to classical-mechanics. This includes tasks such as:
- model systems
- predict behavior
- analyze motion
...
1. The user explicitly requests verification in the context of classical-mechanics
