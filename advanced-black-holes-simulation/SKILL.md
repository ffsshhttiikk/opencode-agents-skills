# Advanced Black Holes Simulation Skill

## Overview
This skill enables simulation in the domain of black-holes (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to black-holes. This includes tasks such as:
- detect signals
- model phenomena
- analyze spectra
...
1. The user explicitly requests simulation in the context of black-holes
2. The task requires expert-level understanding of astronomy principles
3. The output needs to be celestial coordinates
4. The work involves black-holes methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of black-holes principles and methods
...
2. **Methodology**: Follow established black-holes protocols and best practices
...
- Adjacent black-holes skills for comprehensive analysis
...
7. Stay current with black-holes literature and methods

## Version Information
- Complexity Level: expert
- Domain: astronomy
- Subdiscipline: black-holes
