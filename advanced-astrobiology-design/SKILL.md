# Advanced Astrobiology Design Skill

## Overview
This skill enables design in the domain of astrobiology (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to astrobiology. This includes tasks such as:
- calculate orbits
- measure distances
- analyze spectra
...
1. The user explicitly requests design in the context of astrobiology
