# A B Testing Simulation Research Level Skill

## Overview
This skill enables simulation in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to a-b-testing. This includes tasks such as:
- analyze datasets
- analyze datasets
- extract features
...
1. The user explicitly requests simulation in the context of a-b-testing
