# Advanced Causal Inference Estimation Skill

## Overview
This skill enables estimation in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to causal-inference. This includes tasks such as:
- test hypotheses
- predict outcomes
- build models
...
1. The user explicitly requests estimation in the context of causal-inference
