# Advanced Biophysics Estimation Skill

## Overview
This skill enables estimation in the domain of biophysics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to biophysics. This includes tasks such as:
- measure quantities
- model systems
- calculate forces
...
1. The user explicitly requests estimation in the context of biophysics
2. The task requires intermediate-level understanding of physics principles
3. The output needs to be physical predictions
4. The work involves biophysics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of biophysics principles and methods
...
2. **Methodology**: Follow established biophysics protocols and best practices
...
- Adjacent biophysics skills for comprehensive analysis
...
7. Stay current with biophysics literature and methods
