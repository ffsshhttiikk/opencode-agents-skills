# Advanced Cell Biology Analysis Skill

## Overview
This skill enables analysis in the domain of cell-biology (biology). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to cell-biology. This includes tasks such as:
- classify organisms
- measure expression
- measure expression
...
1. The user explicitly requests analysis in the context of cell-biology
