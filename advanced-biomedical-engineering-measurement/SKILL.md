# Advanced Biomedical Engineering Measurement Skill

## Overview
This skill enables measurement in the domain of biomedical-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to biomedical-engineering. This includes tasks such as:
...
1. The user explicitly requests measurement in the context of biomedical-engineering
