# Advanced Algebraic Geometry Modeling Skill

## Overview
This skill enables modeling in the domain of algebraic-geometry (mathematics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to algebraic-geometry. This includes tasks such as:
- prove theorems
- calculate integrals
- solve equations
...
1. The user explicitly requests modeling in the context of algebraic-geometry
