# Advanced Atmospheric Physics Synthesis Skill

## Overview
This skill enables synthesis in the domain of atmospheric-physics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to atmospheric-physics. This includes tasks such as:
- measure quantities
- analyze motion
- predict behavior
...
1. The user explicitly requests synthesis in the context of atmospheric-physics
