# Advanced Astrochemistry Optimization Skill

## Overview
This skill enables optimization in the domain of astrochemistry (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to astrochemistry. This includes tasks such as:
...
1. The user explicitly requests optimization in the context of astrochemistry
