# Advanced Algorithms Optimization Skill

## Overview
This skill enables optimization in the domain of algorithms (computer-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to algorithms. This includes tasks such as:
- optimize code
- design systems
- analyze complexity
...
1. The user explicitly requests optimization in the context of algorithms
...
4. The work involves algorithms methodologies or techniques
...
2. **Methodology**: Follow established algorithms protocols and best practices
...
7. Stay current with algorithms literature and methods
