# Advanced Bayesian Statistics Prediction Skill

## Overview
This skill enables prediction in the domain of bayesian-statistics (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to bayesian-statistics. This includes tasks such as:
- build models
- visualize data
- test hypotheses
...
1. The user explicitly requests prediction in the context of bayesian-statistics
