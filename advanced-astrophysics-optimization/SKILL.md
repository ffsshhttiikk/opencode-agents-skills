# Advanced Astrophysics Optimization Skill

## Overview
This skill enables optimization in the domain of astrophysics (physics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to astrophysics. This includes tasks such as:
...
1. The user explicitly requests optimization in the context of astrophysics
2. The task requires research-level-level understanding of physics principles
3. The output needs to be theoretical models
4. The work involves astrophysics methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of astrophysics principles and methods
...
2. **Methodology**: Follow established astrophysics protocols and best practices
...
- Adjacent astrophysics skills for comprehensive analysis
...
7. Stay current with astrophysics literature and methods
