# Advanced Cartography Measurement Skill

## Overview
This skill enables measurement in the domain of cartography (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to cartography. This includes tasks such as:
- analyze samples
- interpret data
- map features
...
1. The user explicitly requests measurement in the context of cartography
