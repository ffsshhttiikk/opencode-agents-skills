# Advanced Big Data Characterization Skill

## Overview
This skill enables characterization in the domain of big-data (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to big-data. This includes tasks such as:
- build models
- analyze datasets
- predict outcomes
...
1. The user explicitly requests characterization in the context of big-data
