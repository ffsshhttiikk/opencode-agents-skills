# A B Testing Optimization Research Level Skill

## Overview
This skill enables optimization in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to a-b-testing. This includes tasks such as:
- analyze datasets
- build models
- predict outcomes
...
1. The user explicitly requests optimization in the context of a-b-testing
