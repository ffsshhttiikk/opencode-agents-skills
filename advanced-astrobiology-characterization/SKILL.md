# Advanced Astrobiology Characterization Skill

## Overview
This skill enables characterization in the domain of astrobiology (astronomy). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to astrobiology. This includes tasks such as:
- model phenomena
- model phenomena
- analyze spectra
...
1. The user explicitly requests characterization in the context of astrobiology
