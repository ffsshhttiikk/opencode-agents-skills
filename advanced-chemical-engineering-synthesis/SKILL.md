# Advanced Chemical Engineering Synthesis Skill

## Overview
This skill enables synthesis in the domain of chemical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to chemical-engineering. This includes tasks such as:
- test prototypes
- design components
- optimize processes
...
1. The user explicitly requests synthesis in the context of chemical-engineering
