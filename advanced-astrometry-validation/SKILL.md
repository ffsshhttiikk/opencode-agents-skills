# Advanced Astrometry Validation Skill

## Overview
This skill enables validation in the domain of astrometry (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to astrometry. This includes tasks such as:
- model phenomena
- analyze spectra
- measure distances
...
1. The user explicitly requests validation in the context of astrometry
