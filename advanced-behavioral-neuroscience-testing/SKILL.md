# Advanced Behavioral Neuroscience Testing Skill

## Overview
This skill enables testing in the domain of behavioral-neuroscience (neuroscience). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to behavioral-neuroscience. This includes tasks such as:
- model circuits
...
1. The user explicitly requests testing in the context of behavioral-neuroscience
