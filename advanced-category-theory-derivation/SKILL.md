# Advanced Category Theory Derivation Skill

## Overview
This skill enables derivation in the domain of category-theory (mathematics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to category-theory. This includes tasks such as:
- compute derivatives
- find eigenvalues
- prove theorems
...
1. The user explicitly requests derivation in the context of category-theory
