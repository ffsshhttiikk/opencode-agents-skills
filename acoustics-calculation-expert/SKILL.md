# Acoustics Calculation Expert Skill

## Overview
This skill enables calculation in the domain of acoustics (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to acoustics. This includes tasks such as:
- calculate forces
- calculate forces
...
1. The user explicitly requests calculation in the context of acoustics
