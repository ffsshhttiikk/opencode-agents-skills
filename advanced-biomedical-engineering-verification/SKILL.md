# Advanced Biomedical Engineering Verification Skill

## Overview
This skill enables verification in the domain of biomedical-engineering (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to biomedical-engineering. This includes tasks such as:
- analyze structures
- optimize processes
- design components
...
1. The user explicitly requests verification in the context of biomedical-engineering
