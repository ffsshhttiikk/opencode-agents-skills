# Acoustics Based Analysis Skill

## Overview
This skill enables analysis in the domain of acoustics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to acoustics. This includes tasks such as:
- analyze motion
- measure quantities
- predict behavior
...
1. The user explicitly requests analysis in the context of acoustics
