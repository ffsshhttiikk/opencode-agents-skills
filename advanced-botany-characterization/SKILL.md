# Advanced Botany Characterization Skill

## Overview
This skill enables characterization in the domain of botany (biology). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to botany. This includes tasks such as:
- classify organisms
- analyze proteins
- classify organisms
...
1. The user explicitly requests characterization in the context of botany
