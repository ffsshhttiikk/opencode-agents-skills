# Advanced Astrometry Optimization Skill

## Overview
This skill enables optimization in the domain of astrometry (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to astrometry. This includes tasks such as:
- analyze spectra
- measure distances
- measure distances
...
1. The user explicitly requests optimization in the context of astrometry
