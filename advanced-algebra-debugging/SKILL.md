# Advanced Algebra Debugging Skill

## Overview
This skill enables debugging in the domain of algebra (mathematics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to algebra. This includes tasks such as:
- find eigenvalues
- find eigenvalues
- analyze functions
...
1. The user explicitly requests debugging in the context of algebra
