# Advanced Astrophysics Validation Skill

## Overview
This skill enables validation in the domain of astrophysics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to astrophysics. This includes tasks such as:
- predict behavior
- predict behavior
- model systems
...
1. The user explicitly requests validation in the context of astrophysics
