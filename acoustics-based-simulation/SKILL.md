# Acoustics Based Simulation Skill

## Overview
This skill enables simulation in the domain of acoustics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to acoustics. This includes tasks such as:
- calculate forces
...
1. The user explicitly requests simulation in the context of acoustics
