# A B Testing Prediction Research Level Skill

## Overview
This skill enables prediction in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to a-b-testing. This includes tasks such as:
- analyze datasets
- visualize data
- predict outcomes
...
1. The user explicitly requests prediction in the context of a-b-testing
