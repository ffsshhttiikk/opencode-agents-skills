# Advanced Big Data Implementation Skill

## Overview
This skill enables implementation in the domain of big-data (data-science). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to big-data. This includes tasks such as:
- predict outcomes
- analyze datasets
- visualize data
...
1. The user explicitly requests implementation in the context of big-data
