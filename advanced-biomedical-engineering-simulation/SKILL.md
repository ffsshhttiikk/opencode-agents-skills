# Advanced Biomedical Engineering Simulation Skill

## Overview
This skill enables simulation in the domain of biomedical-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to biomedical-engineering. This includes tasks such as:
...
1. The user explicitly requests simulation in the context of biomedical-engineering
