# Advanced Cell Biology Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of cell-biology (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to cell-biology. This includes tasks such as:
- model populations
- study interactions
- study interactions
...
1. The user explicitly requests troubleshooting in the context of cell-biology
2. The task requires fundamental-level understanding of biology principles
3. The output needs to be phylogenetic trees
4. The work involves cell-biology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of cell-biology principles and methods
...
- **Tool Proficiency**: Effective use of microscopy
...
2. **Methodology**: Follow established cell-biology protocols and best practices
...
- Adjacent cell-biology skills for comprehensive analysis
...
7. Stay current with cell-biology literature and methods

## Version Information
- Complexity Level: fundamental
- Domain: biology
- Subdiscipline: cell-biology
