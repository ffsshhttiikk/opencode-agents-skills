# Advanced Atmospheric Physics Verification Skill

## Overview
This skill enables verification in the domain of atmospheric-physics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to atmospheric-physics. This includes tasks such as:
- predict behavior
- predict behavior
- model systems
...
1. The user explicitly requests verification in the context of atmospheric-physics
