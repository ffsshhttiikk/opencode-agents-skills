# Advanced Botany Validation Skill

## Overview
This skill enables validation in the domain of botany (biology). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to botany. This includes tasks such as:
- analyze proteins
- classify organisms
- measure expression
...
1. The user explicitly requests validation in the context of botany
