# Advanced Analytical Chemistry Synthesis Skill

## Overview
This skill enables synthesis in the domain of analytical-chemistry (chemistry). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to analytical-chemistry. This includes tasks such as:
- analyze spectra
...
1. The user explicitly requests synthesis in the context of analytical-chemistry
