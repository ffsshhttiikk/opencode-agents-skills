# Advanced Astrophotography Interpretation Skill

## Overview
This skill enables interpretation in the domain of astrophotography (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to astrophotography. This includes tasks such as:
- detect signals
- model phenomena
- analyze spectra
...
1. The user explicitly requests interpretation in the context of astrophotography
