# Advanced Astrophotography Testing Skill

## Overview
This skill enables testing in the domain of astrophotography (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to astrophotography. This includes tasks such as:
- model phenomena
- calculate orbits
- detect signals
...
1. The user explicitly requests testing in the context of astrophotography
