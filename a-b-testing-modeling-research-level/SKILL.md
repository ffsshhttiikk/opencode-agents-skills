# A B Testing Modeling Research Level Skill

## Overview
This skill enables modeling in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to a-b-testing. This includes tasks such as:
- extract features
- predict outcomes
- visualize data
...
1. The user explicitly requests modeling in the context of a-b-testing
