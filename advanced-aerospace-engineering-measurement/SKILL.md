# Advanced Aerospace Engineering Measurement Skill

## Overview
This skill enables measurement in the domain of aerospace-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to aerospace-engineering. This includes tasks such as:
- optimize processes
- analyze structures
...
1. The user explicitly requests measurement in the context of aerospace-engineering
