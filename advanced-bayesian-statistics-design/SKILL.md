# Advanced Bayesian Statistics Design Skill

## Overview
This skill enables design in the domain of bayesian-statistics (data-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to bayesian-statistics. This includes tasks such as:
- visualize data
- predict outcomes
- build models
...
1. The user explicitly requests design in the context of bayesian-statistics
