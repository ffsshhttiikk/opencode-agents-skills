# Advanced Astrophotography Validation Skill

## Overview
This skill enables validation in the domain of astrophotography (astronomy). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to astrophotography. This includes tasks such as:
- calculate orbits
- model phenomena
- model phenomena
...
1. The user explicitly requests validation in the context of astrophotography
