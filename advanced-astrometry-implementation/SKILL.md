# Advanced Astrometry Implementation Skill

## Overview
This skill enables implementation in the domain of astrometry (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform implementation operations related to astrometry. This includes tasks such as:
- model phenomena
- detect signals
- measure distances
...
1. The user explicitly requests implementation in the context of astrometry
