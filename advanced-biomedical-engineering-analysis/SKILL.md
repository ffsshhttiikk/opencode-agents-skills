# Advanced Biomedical Engineering Analysis Skill

## Overview
This skill enables analysis in the domain of biomedical-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to biomedical-engineering. This includes tasks such as:
- analyze structures
- analyze structures
- design components
...
1. The user explicitly requests analysis in the context of biomedical-engineering
