# Advanced Atmospheric Science Interpretation Skill

## Overview
This skill enables interpretation in the domain of atmospheric-science (earth-sciences). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to atmospheric-science. This includes tasks such as:
- predict events
- map features
- measure properties
...
1. The user explicitly requests interpretation in the context of atmospheric-science
