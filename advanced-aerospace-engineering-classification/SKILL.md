# Advanced Aerospace Engineering Classification Skill

## Overview
This skill enables classification in the domain of aerospace-engineering (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to aerospace-engineering. This includes tasks such as:
- optimize processes
- validate designs
- optimize processes
...
1. The user explicitly requests classification in the context of aerospace-engineering
