# Advanced Cartography Characterization Skill

## Overview
This skill enables characterization in the domain of cartography (earth-sciences). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to cartography. This includes tasks such as:
- predict events
- predict events
- predict events
...
1. The user explicitly requests characterization in the context of cartography
