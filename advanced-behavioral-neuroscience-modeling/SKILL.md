# Advanced Behavioral Neuroscience Modeling Skill

## Overview
This skill enables modeling in the domain of behavioral-neuroscience (neuroscience). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to behavioral-neuroscience. This includes tasks such as:
...
1. The user explicitly requests modeling in the context of behavioral-neuroscience
