# Advanced Anomaly Detection Testing Skill

## Overview
This skill enables testing in the domain of anomaly-detection (data-science). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to anomaly-detection. This includes tasks such as:
- build models
- build models
- build models
...
1. The user explicitly requests testing in the context of anomaly-detection
