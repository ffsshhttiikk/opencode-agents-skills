# Advanced Astrobiology Testing Skill

## Overview
This skill enables testing in the domain of astrobiology (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to astrobiology. This includes tasks such as:
- measure distances
- observe objects
- analyze spectra
...
1. The user explicitly requests testing in the context of astrobiology
