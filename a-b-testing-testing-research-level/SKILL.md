# A B Testing Testing Research Level Skill

## Overview
This skill enables testing in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to a-b-testing. This includes tasks such as:
- analyze datasets
- analyze datasets
- test hypotheses
...
1. The user explicitly requests testing in the context of a-b-testing
