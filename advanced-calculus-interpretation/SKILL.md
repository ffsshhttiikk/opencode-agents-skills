# Advanced Calculus Interpretation Skill

## Overview
This skill enables interpretation in the domain of calculus (mathematics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to calculus. This includes tasks such as:
- solve equations
- analyze functions
- solve equations
...
1. The user explicitly requests interpretation in the context of calculus
