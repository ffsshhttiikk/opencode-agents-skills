# Advanced Automotive Engineering Validation Skill

## Overview
This skill enables validation in the domain of automotive-engineering (engineering). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform validation operations related to automotive-engineering. This includes tasks such as:
- design components
- analyze structures
- analyze structures
...
1. The user explicitly requests validation in the context of automotive-engineering
2. The task requires advanced-level understanding of engineering principles
3. The output needs to be performance analyses
4. The work involves automotive-engineering methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of automotive-engineering principles and methods
...
2. **Methodology**: Follow established automotive-engineering protocols and best practices
...
- Adjacent automotive-engineering skills for comprehensive analysis
...
7. Stay current with automotive-engineering literature and methods

## Version Information
- Complexity Level: advanced
- Domain: engineering
- Subdiscipline: automotive-engineering
