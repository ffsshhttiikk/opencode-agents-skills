# Advanced Causal Inference Analysis Skill

## Overview
This skill enables analysis in the domain of causal-inference (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to causal-inference. This includes tasks such as:
- analyze datasets
- build models
- predict outcomes
...
1. The user explicitly requests analysis in the context of causal-inference
