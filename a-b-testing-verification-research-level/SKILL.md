# A B Testing Verification Research Level Skill

## Overview
This skill enables verification in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to a-b-testing. This includes tasks such as:
- test hypotheses
- test hypotheses
- test hypotheses
...
1. The user explicitly requests verification in the context of a-b-testing
