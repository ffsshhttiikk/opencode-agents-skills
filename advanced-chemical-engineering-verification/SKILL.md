# Advanced Chemical Engineering Verification Skill

## Overview
This skill enables verification in the domain of chemical-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to chemical-engineering. This includes tasks such as:
- design components
- design components
- test prototypes
...
1. The user explicitly requests verification in the context of chemical-engineering
