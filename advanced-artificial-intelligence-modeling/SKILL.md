# Advanced Artificial Intelligence Modeling Skill

## Overview
This skill enables modeling in the domain of artificial-intelligence (computer-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to artificial-intelligence. This includes tasks such as:
- design systems
- optimize code
- debug programs
...
1. The user explicitly requests modeling in the context of artificial-intelligence
