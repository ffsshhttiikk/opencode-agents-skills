# Advanced Astrobiology Derivation Skill

## Overview
This skill enables derivation in the domain of astrobiology (astronomy). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to astrobiology. This includes tasks such as:
- observe objects
- detect signals
- measure distances
...
1. The user explicitly requests derivation in the context of astrobiology
