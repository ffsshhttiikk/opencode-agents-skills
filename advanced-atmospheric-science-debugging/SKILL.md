# Advanced Atmospheric Science Debugging Skill

## Overview
This skill enables debugging in the domain of atmospheric-science (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to atmospheric-science. This includes tasks such as:
- analyze samples
- map features
- model processes
...
1. The user explicitly requests debugging in the context of atmospheric-science
