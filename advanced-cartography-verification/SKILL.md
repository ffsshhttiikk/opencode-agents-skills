# Advanced Cartography Verification Skill

## Overview
This skill enables verification in the domain of cartography (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to cartography. This includes tasks such as:
- map features
- interpret data
- analyze samples
...
1. The user explicitly requests verification in the context of cartography
2. The task requires intermediate-level understanding of earth-sciences principles
3. The output needs to be geological maps
4. The work involves cartography methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of cartography principles and methods
...
2. **Methodology**: Follow established cartography protocols and best practices
...
- Adjacent cartography skills for comprehensive analysis
...
7. Stay current with cartography literature and methods

## Version Information
- Complexity Level: intermediate
- Domain: earth-sciences
- Subdiscipline: cartography
