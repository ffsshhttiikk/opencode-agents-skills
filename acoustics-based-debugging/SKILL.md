# Acoustics Based Debugging Skill

## Overview
This skill enables debugging in the domain of acoustics (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to acoustics. This includes tasks such as:
- calculate forces
...
1. The user explicitly requests debugging in the context of acoustics
