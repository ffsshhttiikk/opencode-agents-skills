# Advanced Atmospheric Physics Design Skill

## Overview
This skill enables design in the domain of atmospheric-physics (physics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to atmospheric-physics. This includes tasks such as:
- measure quantities
- calculate forces
- calculate forces
...
1. The user explicitly requests design in the context of atmospheric-physics
