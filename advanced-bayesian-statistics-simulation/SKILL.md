# Advanced Bayesian Statistics Simulation Skill

## Overview
This skill enables simulation in the domain of bayesian-statistics (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to bayesian-statistics. This includes tasks such as:
- analyze datasets
- extract features
- visualize data
...
1. The user explicitly requests simulation in the context of bayesian-statistics
