# Advanced Biophysics Verification Skill

## Overview
This skill enables verification in the domain of biophysics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform verification operations related to biophysics. This includes tasks such as:
- model systems
- calculate forces
- calculate forces
...
1. The user explicitly requests verification in the context of biophysics
