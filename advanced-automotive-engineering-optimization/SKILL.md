# Advanced Automotive Engineering Optimization Skill

## Overview
This skill enables optimization in the domain of automotive-engineering (engineering). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to automotive-engineering. This includes tasks such as:
- validate designs
- analyze structures
...
1. The user explicitly requests optimization in the context of automotive-engineering
