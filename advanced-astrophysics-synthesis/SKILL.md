# Advanced Astrophysics Synthesis Skill

## Overview
This skill enables synthesis in the domain of astrophysics (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to astrophysics. This includes tasks such as:
- predict behavior
- predict behavior
- model systems
...
1. The user explicitly requests synthesis in the context of astrophysics
