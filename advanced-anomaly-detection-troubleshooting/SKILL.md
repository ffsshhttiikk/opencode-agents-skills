# Advanced Anomaly Detection Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of anomaly-detection (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to anomaly-detection. This includes tasks such as:
- build models
- test hypotheses
- build models
...
1. The user explicitly requests troubleshooting in the context of anomaly-detection
