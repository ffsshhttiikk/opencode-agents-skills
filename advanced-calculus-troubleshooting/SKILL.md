# Advanced Calculus Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of calculus (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to calculus. This includes tasks such as:
- find eigenvalues
- solve equations
- compute derivatives
...
1. The user explicitly requests troubleshooting in the context of calculus
