# Advanced Behavioral Neuroscience Optimization Skill

## Overview
This skill enables optimization in the domain of behavioral-neuroscience (neuroscience). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to behavioral-neuroscience. This includes tasks such as:
...
1. The user explicitly requests optimization in the context of behavioral-neuroscience
