# Advanced Big Data Measurement Skill

## Overview
This skill enables measurement in the domain of big-data (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to big-data. This includes tasks such as:
- predict outcomes
- extract features
- predict outcomes
...
1. The user explicitly requests measurement in the context of big-data
