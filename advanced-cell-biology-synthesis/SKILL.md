# Advanced Cell Biology Synthesis Skill

## Overview
This skill enables synthesis in the domain of cell-biology (biology). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to cell-biology. This includes tasks such as:
- model populations
- sequence DNA
- analyze proteins
...
1. The user explicitly requests synthesis in the context of cell-biology
