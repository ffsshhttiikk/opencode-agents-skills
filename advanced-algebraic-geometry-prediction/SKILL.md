# Advanced Algebraic Geometry Prediction Skill

## Overview
This skill enables prediction in the domain of algebraic-geometry (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to algebraic-geometry. This includes tasks such as:
- find eigenvalues
- prove theorems
- analyze functions
...
1. The user explicitly requests prediction in the context of algebraic-geometry
