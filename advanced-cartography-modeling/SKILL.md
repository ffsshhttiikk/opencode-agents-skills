# Advanced Cartography Modeling Skill

## Overview
This skill enables modeling in the domain of cartography (earth-sciences). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to cartography. This includes tasks such as:
- predict events
- predict events
- predict events
...
1. The user explicitly requests modeling in the context of cartography
...
- **Tool Proficiency**: Effective use of GIS software
