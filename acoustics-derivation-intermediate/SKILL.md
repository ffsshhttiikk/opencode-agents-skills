# Acoustics Derivation Intermediate Skill

## Overview
This skill enables derivation in the domain of acoustics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to acoustics. This includes tasks such as:
- predict behavior
- model systems
- analyze motion
...
1. The user explicitly requests derivation in the context of acoustics
