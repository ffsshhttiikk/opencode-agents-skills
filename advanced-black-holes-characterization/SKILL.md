# Advanced Black Holes Characterization Skill

## Overview
This skill enables characterization in the domain of black-holes (astronomy). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to black-holes. This includes tasks such as:
- model phenomena
- measure distances
- detect signals
...
1. The user explicitly requests characterization in the context of black-holes
