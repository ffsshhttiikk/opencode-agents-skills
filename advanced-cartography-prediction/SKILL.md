# Advanced Cartography Prediction Skill

## Overview
This skill enables prediction in the domain of cartography (earth-sciences). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to cartography. This includes tasks such as:
- interpret data
- model processes
- model processes
...
1. The user explicitly requests prediction in the context of cartography
2. The task requires research-level-level understanding of earth-sciences principles
