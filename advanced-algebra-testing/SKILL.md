# Advanced Algebra Testing Skill

## Overview
This skill enables testing in the domain of algebra (mathematics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform testing operations related to algebra. This includes tasks such as:
- solve equations
- compute derivatives
- calculate integrals
...
1. The user explicitly requests testing in the context of algebra
