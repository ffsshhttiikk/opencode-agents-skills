# Advanced Causal Inference Modeling Skill

## Overview
This skill enables modeling in the domain of causal-inference (data-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to causal-inference. This includes tasks such as:
- extract features
- build models
- predict outcomes
...
1. The user explicitly requests modeling in the context of causal-inference
