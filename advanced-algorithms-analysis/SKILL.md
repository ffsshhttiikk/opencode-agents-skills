# Advanced Algorithms Analysis Skill

## Overview
This skill enables analysis in the domain of algorithms (computer-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform analysis operations related to algorithms. This includes tasks such as:
- optimize code
- debug programs
- analyze complexity
...
1. The user explicitly requests analysis in the context of algorithms
