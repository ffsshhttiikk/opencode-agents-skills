# Advanced Causal Inference Calculation Skill

## Overview
This skill enables calculation in the domain of causal-inference (data-science). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to causal-inference. This includes tasks such as:
- analyze datasets
- test hypotheses
- test hypotheses
...
1. The user explicitly requests calculation in the context of causal-inference
