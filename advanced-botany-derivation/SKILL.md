# Advanced Botany Derivation Skill

## Overview
This skill enables derivation in the domain of botany (biology). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to botany. This includes tasks such as:
- sequence DNA
- measure expression
- analyze proteins
...
1. The user explicitly requests derivation in the context of botany
