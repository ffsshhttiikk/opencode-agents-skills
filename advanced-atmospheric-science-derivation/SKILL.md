# Advanced Atmospheric Science Derivation Skill

## Overview
This skill enables derivation in the domain of atmospheric-science (earth-sciences). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to atmospheric-science. This includes tasks such as:
- interpret data
- measure properties
- analyze samples
...
1. The user explicitly requests derivation in the context of atmospheric-science
