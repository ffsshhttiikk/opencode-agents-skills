# Advanced Chemical Engineering Calculation Skill

## Overview
This skill enables calculation in the domain of chemical-engineering (engineering). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to chemical-engineering. This includes tasks such as:
...
1. The user explicitly requests calculation in the context of chemical-engineering
