# Advanced Astrophotography Simulation Skill

## Overview
This skill enables simulation in the domain of astrophotography (astronomy). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to astrophotography. This includes tasks such as:
- observe objects
- measure distances
- model phenomena
...
1. The user explicitly requests simulation in the context of astrophotography
