# Advanced Chemical Engineering Design Skill

## Overview
This skill enables design in the domain of chemical-engineering (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to chemical-engineering. This includes tasks such as:
- analyze structures
- analyze structures
- design components
...
1. The user explicitly requests design in the context of chemical-engineering
