# Advanced Big Data Optimization Skill

## Overview
This skill enables optimization in the domain of big-data (data-science). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to big-data. This includes tasks such as:
- predict outcomes
- predict outcomes
- build models
...
1. The user explicitly requests optimization in the context of big-data
