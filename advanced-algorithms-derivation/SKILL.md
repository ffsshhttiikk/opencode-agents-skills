# Advanced Algorithms Derivation Skill

## Overview
This skill enables derivation in the domain of algorithms (computer-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to algorithms. This includes tasks such as:
- analyze complexity
- train models
- debug programs
...
1. The user explicitly requests derivation in the context of algorithms
