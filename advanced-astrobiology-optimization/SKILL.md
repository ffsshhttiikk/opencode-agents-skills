# Advanced Astrobiology Optimization Skill

## Overview
This skill enables optimization in the domain of astrobiology (astronomy). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to astrobiology. This includes tasks such as:
- detect signals
- observe objects
- measure distances
...
1. The user explicitly requests optimization in the context of astrobiology
2. The task requires intermediate-level understanding of astronomy principles
3. The output needs to be physical models
4. The work involves astrobiology methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of astrobiology principles and methods
...
2. **Methodology**: Follow established astrobiology protocols and best practices
...
## Output Format
The skill produces celestial coordinates in standardized formats appropriate for astronomy applications. Outputs include:
...
- Adjacent astrobiology skills for comprehensive analysis
...
7. Stay current with astrobiology literature and methods

## Version Information
- Complexity Level: intermediate
- Domain: astronomy
- Subdiscipline: astrobiology
