# Advanced Astrophotography Measurement Skill

## Overview
This skill enables measurement in the domain of astrophotography (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to astrophotography. This includes tasks such as:
- calculate orbits
- measure distances
- detect signals
...
1. The user explicitly requests measurement in the context of astrophotography
