# Advanced Chemical Engineering Interpretation Skill

## Overview
This skill enables interpretation in the domain of chemical-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to chemical-engineering. This includes tasks such as:
- test prototypes
- analyze structures
- optimize processes
...
1. The user explicitly requests interpretation in the context of chemical-engineering
