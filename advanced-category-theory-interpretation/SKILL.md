# Advanced Category Theory Interpretation Skill

## Overview
This skill enables interpretation in the domain of category-theory (mathematics). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to category-theory. This includes tasks such as:
- compute derivatives
- calculate integrals
- prove theorems
...
1. The user explicitly requests interpretation in the context of category-theory
