# Advanced Automotive Engineering Characterization Skill

## Overview
This skill enables characterization in the domain of automotive-engineering (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to automotive-engineering. This includes tasks such as:
- analyze structures
- optimize processes
- optimize processes
...
1. The user explicitly requests characterization in the context of automotive-engineering
