# Advanced Calculus Derivation Skill

## Overview
This skill enables derivation in the domain of calculus (mathematics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform derivation operations related to calculus. This includes tasks such as:
- compute derivatives
- compute derivatives
- solve equations
...
1. The user explicitly requests derivation in the context of calculus
2. The task requires intermediate-level understanding of mathematics principles
3. The output needs to be numerical approximations
4. The work involves calculus methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of calculus principles and methods
...
2. **Methodology**: Follow established calculus protocols and best practices
...
- Adjacent calculus skills for comprehensive analysis
...
7. Stay current with calculus literature and methods
