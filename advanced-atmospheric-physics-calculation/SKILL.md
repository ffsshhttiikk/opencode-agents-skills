# Advanced Atmospheric Physics Calculation Skill

## Overview
This skill enables calculation in the domain of atmospheric-physics (physics). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform calculation operations related to atmospheric-physics. This includes tasks such as:
- calculate forces
- measure quantities
...
1. The user explicitly requests calculation in the context of atmospheric-physics
