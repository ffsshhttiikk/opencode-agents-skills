# Advanced Catalysis Modeling Skill

## Overview
This skill enables modeling in the domain of catalysis (chemistry). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to catalysis. This includes tasks such as:
...
1. The user explicitly requests modeling in the context of catalysis
