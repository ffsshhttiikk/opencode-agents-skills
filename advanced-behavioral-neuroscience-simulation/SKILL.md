# Advanced Behavioral Neuroscience Simulation Skill

## Overview
This skill enables simulation in the domain of behavioral-neuroscience (neuroscience). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to behavioral-neuroscience. This includes tasks such as:
...
1. The user explicitly requests simulation in the context of behavioral-neuroscience
