# Advanced Algebra Synthesis Skill

## Overview
This skill enables synthesis in the domain of algebra (mathematics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to algebra. This includes tasks such as:
- prove theorems
- calculate integrals
- calculate integrals
...
1. The user explicitly requests synthesis in the context of algebra
