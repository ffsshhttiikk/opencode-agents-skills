# Advanced Acoustics Optimization Skill

## Overview
This skill enables optimization in the domain of acoustics (physics). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform optimization operations related to acoustics. This includes tasks such as:
- model systems
- analyze motion
- model systems
...
1. The user explicitly requests optimization in the context of acoustics
