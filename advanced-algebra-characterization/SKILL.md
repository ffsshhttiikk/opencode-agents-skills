# Advanced Algebra Characterization Skill

## Overview
This skill enables characterization in the domain of algebra (mathematics). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform characterization operations related to algebra. This includes tasks such as:
- find eigenvalues
- find eigenvalues
- compute derivatives
...
1. The user explicitly requests characterization in the context of algebra
