# Advanced Black Holes Design Skill

## Overview
This skill enables design in the domain of black-holes (astronomy). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to black-holes. This includes tasks such as:
- detect signals
- measure distances
- observe objects
...
1. The user explicitly requests design in the context of black-holes
