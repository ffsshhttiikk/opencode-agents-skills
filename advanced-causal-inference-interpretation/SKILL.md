# Advanced Causal Inference Interpretation Skill

## Overview
This skill enables interpretation in the domain of causal-inference (data-science). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform interpretation operations related to causal-inference. This includes tasks such as:
- extract features
- predict outcomes
- analyze datasets
...
1. The user explicitly requests interpretation in the context of causal-inference
