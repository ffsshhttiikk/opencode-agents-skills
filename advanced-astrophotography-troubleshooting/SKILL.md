# Advanced Astrophotography Troubleshooting Skill

## Overview
This skill enables troubleshooting in the domain of astrophotography (astronomy). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform troubleshooting operations related to astrophotography. This includes tasks such as:
- calculate orbits
- model phenomena
- measure distances
...
1. The user explicitly requests troubleshooting in the context of astrophotography
