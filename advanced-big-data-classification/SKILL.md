# Advanced Big Data Classification Skill

## Overview
This skill enables classification in the domain of big-data (data-science). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform classification operations related to big-data. This includes tasks such as:
- build models
- extract features
- build models
...
1. The user explicitly requests classification in the context of big-data
