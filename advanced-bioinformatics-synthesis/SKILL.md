# Advanced Bioinformatics Synthesis Skill

## Overview
This skill enables synthesis in the domain of bioinformatics (biology). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to bioinformatics. This includes tasks such as:
- classify organisms
- analyze proteins
- measure expression
...
1. The user explicitly requests synthesis in the context of bioinformatics
