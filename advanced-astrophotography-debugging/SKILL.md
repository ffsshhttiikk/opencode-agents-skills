# Advanced Astrophotography Debugging Skill

## Overview
This skill enables debugging in the domain of astrophotography (astronomy). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to astrophotography. This includes tasks such as:
- observe objects
- calculate orbits
- analyze spectra
...
1. The user explicitly requests debugging in the context of astrophotography
