# Advanced Behavioral Neuroscience Design Skill

## Overview
This skill enables design in the domain of behavioral-neuroscience (neuroscience). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform design operations related to behavioral-neuroscience. This includes tasks such as:
...
1. The user explicitly requests design in the context of behavioral-neuroscience
2. The task requires advanced-level understanding of neuroscience principles
