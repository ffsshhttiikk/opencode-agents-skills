# Advanced Big Data Simulation Skill

## Overview
This skill enables simulation in the domain of big-data (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform simulation operations related to big-data. This includes tasks such as:
- test hypotheses
- predict outcomes
- analyze datasets
...
1. The user explicitly requests simulation in the context of big-data
