# Advanced Biomedical Engineering Debugging Skill

## Overview
This skill enables debugging in the domain of biomedical-engineering (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform debugging operations related to biomedical-engineering. This includes tasks such as:
- design components
- optimize processes
- design components
...
1. The user explicitly requests debugging in the context of biomedical-engineering
