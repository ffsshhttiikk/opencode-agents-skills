# Advanced Aerospace Engineering Estimation Skill

## Overview
This skill enables estimation in the domain of aerospace-engineering (engineering). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to aerospace-engineering. This includes tasks such as:
- design components
- optimize processes
- analyze structures
...
1. The user explicitly requests estimation in the context of aerospace-engineering
