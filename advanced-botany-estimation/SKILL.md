# Advanced Botany Estimation Skill

## Overview
This skill enables estimation in the domain of botany (biology). It represents advanced-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform estimation operations related to botany. This includes tasks such as:
- sequence DNA
- study interactions
- sequence DNA
...
1. The user explicitly requests estimation in the context of botany
