# Advanced Causal Inference Measurement Skill

## Overview
This skill enables measurement in the domain of causal-inference (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to causal-inference. This includes tasks such as:
- test hypotheses
- predict outcomes
- analyze datasets
...
1. The user explicitly requests measurement in the context of causal-inference
2. The task requires research-level-level understanding of data-science principles
3. The output needs to be statistical analyses
4. The work involves causal-inference methodologies or techniques

## Key Capabilities
- **Domain Expertise**: Deep understanding of causal-inference principles and methods
...
2. **Methodology**: Follow established causal-inference protocols and best practices
...
- Adjacent causal-inference skills for comprehensive analysis
...
7. Stay current with causal-inference literature and methods
