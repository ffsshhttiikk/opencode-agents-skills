# Advanced Automotive Engineering Modeling Skill

## Overview
This skill enables modeling in the domain of automotive-engineering (engineering). It represents expert-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform modeling operations related to automotive-engineering. This includes tasks such as:
- optimize processes
- validate designs
...
1. The user explicitly requests modeling in the context of automotive-engineering
