# Advanced Biomedical Engineering Synthesis Skill

## Overview
This skill enables synthesis in the domain of biomedical-engineering (engineering). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform synthesis operations related to biomedical-engineering. This includes tasks such as:
- test prototypes
...
1. The user explicitly requests synthesis in the context of biomedical-engineering
