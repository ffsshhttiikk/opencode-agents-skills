# Advanced Aerospace Engineering Prediction Skill

## Overview
This skill enables prediction in the domain of aerospace-engineering (engineering). It represents intermediate-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to aerospace-engineering. This includes tasks such as:
- optimize processes
- analyze structures
- analyze structures
...
1. The user explicitly requests prediction in the context of aerospace-engineering
