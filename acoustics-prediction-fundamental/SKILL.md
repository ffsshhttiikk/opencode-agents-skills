# Acoustics Prediction Fundamental Skill

## Overview
This skill enables prediction in the domain of acoustics (physics). It represents fundamental-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform prediction operations related to acoustics. This includes tasks such as:
- predict behavior
- predict behavior
- measure quantities
...
1. The user explicitly requests prediction in the context of acoustics
