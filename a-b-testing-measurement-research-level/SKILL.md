# A B Testing Measurement Research Level Skill

## Overview
This skill enables measurement in the domain of a-b-testing (data-science). It represents research-level-level expertise and is designed for production use in research, industry, and educational contexts.

## Description
Use this skill when you need to perform measurement operations related to a-b-testing. This includes tasks such as:
- extract features
- test hypotheses
- test hypotheses
...
1. The user explicitly requests measurement in the context of a-b-testing
